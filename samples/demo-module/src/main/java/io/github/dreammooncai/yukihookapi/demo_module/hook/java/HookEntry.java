 ...
 */
package io.github.dreammooncai.yukihookapi.demo_module.hook.java;
...
import io.github.dreammooncai.yukihookapi.kt.factory.KHookReflectionFactoryKt;
import io.github.dreammooncai.yukireflection.factory.KReflectionFactoryKt;
import kotlin.Unit;
...
public class HookEntry implements IYukiHookXposedInit {
    ...
    public void onHook() {
        ...
        KHookReflectionFactoryKt.encaseKotlin(this, e -> {
            e.loadZygoteKotlin(l -> {
                var result = KReflectionFactoryKt.function(Reflection.createKotlinClass(Activity.class), f -> {
                    f.setName("onCreate");
                    f.param(Bundle.class);
