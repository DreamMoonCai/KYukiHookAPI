 ...
 */
package io.github.dreammooncai.yukihookapi.demo_module.hook.factory
...
import io.github.dreammooncai.yukireflection.factory.currentKotlin
...
fun AlertDialog.compatStyle(): AlertDialog {
    currentKotlin().property { name = "mAlert" }.current {
        arrayOf(
            property { name = "mButtonPositive" }.cast<Button>(),
            property { name = "mButtonNegative" }.cast<Button>(),
            property { name = "mButtonNeutral" }.cast<Button>()
        ).forEach {
