...
package io.github.dreammooncai.yukihookapi.demo_module.ui
...
import io.github.dreammooncai.yukihookapi.demo_module.databinding.ActivityMainBinding
...
class MainActivity : ModuleAppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ActivityMainBinding.inflate(layoutInflater).apply {
            setContentView(root)
            moduleEnvironment {
                dataChannel(packageName = "io.github.dreammooncai.yukihookapi.demo_app").with {
