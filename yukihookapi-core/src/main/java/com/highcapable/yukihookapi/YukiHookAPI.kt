...
import io.github.dreammooncai.yukihookapi.YukiHookAPI_Impl
...
object YukiHookAPI {
    ...
    /** 标签名称 */
    const val TAG = KYukiHookAPIProperties.PROJECT_NAME

    /** 当前版本 */
    const val VERSION = KYukiHookAPIProperties.PROJECT_YUKIHOOKAPI_CORE_VERSION
